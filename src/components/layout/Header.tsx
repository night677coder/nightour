...
import { Search, Menu, X, PlayCircle, Tv, Film, Star, BookOpen } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/watchlist" className="flex items-center space-x-2 hover:text-primary transition-colors">
              <Star className="h-4 w-4" />
              <span>Watchlist</span>
            </Link>
          </nav>
